...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void _informationPage() async {
    Navigator.of(
      context,
    ).pushReplacement(MaterialPageRoute(builder: (_) => InformationPage()));
  }

  void _favoritePokemon() async {
    Navigator.of(
      context,
    ).pushReplacement(MaterialPageRoute(builder: (_) => FavoritePokemonPage()));
  }

  // Fungsi untuk mencari Pokemon berdasarkan nama
  List getPokemonList(String keyword) {
    if (keyword.isEmpty) return pokedex;
    return pokedex
        .where(
